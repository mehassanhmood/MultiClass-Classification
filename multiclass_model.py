...
def define_dense_model_single_layer(input_length, activation_f='sigmoid', output_length=1):
    ...
    model.add(keras.layers.Dense(units=output_length,activation=activation_f,input_shape=(input_length,)))
...
def define_dense_model_with_hidden_layer(input_length, 
    ...
    model = keras.Sequential()
    model.add(keras.layers.Dense(units=hidden_layer_size,activation=activation_func_array[0],input_shape=(input_length,)))
